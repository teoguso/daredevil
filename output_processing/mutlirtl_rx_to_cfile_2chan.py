...
# Generated: Sun Sep 25 11:03:38 2016
##################################################
...
class mutlirtl_rx_to_cfile_2chan(gr.top_block):
    ...
    def __init__(self, ch0_id_string="0", ch1_id_string="1", fname_ch0='../data/ch0.cfile', fname_ch1='../data/ch1.cfile', freq_ch0=524e6, freq_ch1=524e6, freq_corr=0, gain_ch0=30, gain_ch1=30, nsamples=2000000, samp_rate=2e6, sync_freq=522e6, sync_gain_ch0=30, sync_gain_ch1=30):
        ...
        # Connections
        ##################################################
        self.connect((self.head_ch0, 0), (self.rational_resampler_xxx_0, 0))    
        self.connect((self.head_ch1, 0), (self.rational_resampler_xxx_0_0, 0))    
        self.connect((self.multi_rtl_source, 0), (self.head_ch0, 0))    
        self.connect((self.multi_rtl_source, 1), (self.head_ch1, 0))    
        self.connect((self.rational_resampler_xxx_0, 0), (self.file_sink_ch0, 0))    
        self.connect((self.rational_resampler_xxx_0_0, 0), (self.file_sink_ch1, 0))    
...
def argument_parser():
    ...
    parser.add_option(
        "", "--freq-ch0", dest="freq_ch0", type="eng_float", default=eng_notation.num_to_str(524e6),
        help="Set freq-ch0 [default=%default]")
    parser.add_option(
        "", "--freq-ch1", dest="freq_ch1", type="eng_float", default=eng_notation.num_to_str(524e6),
    ...
    parser.add_option(
        "-N", "--nsamples", dest="nsamples", type="intx", default=2000000,
        help="Set nsamples [default=%default]")
    parser.add_option(
        "-r", "--samp-rate", dest="samp_rate", type="eng_float", default=eng_notation.num_to_str(2e6),
        help="Set samp-rate [default=%default]")
    parser.add_option(
        "", "--sync-freq", dest="sync_freq", type="eng_float", default=eng_notation.num_to_str(522e6),
